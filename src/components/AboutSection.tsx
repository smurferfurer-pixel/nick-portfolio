        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-6 text-muted">
              ...
              <p>
                I work mainly with{" "}
                <strong className="text-foreground">n8n</strong>, connecting apps
                like Google Workspace, Slack, CRMs, and AI tools into systems
                that just work — no babysitting required.
              </p>
              <p>
                Every system I build is designed to be maintainable, scalable,
                and actually useful on day one. I don&apos;t do &quot;set it and
                forget it&quot; — I do &quot;set it, test it, optimize it, then
